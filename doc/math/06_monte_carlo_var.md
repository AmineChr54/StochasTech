...
> Risk estimators on top of Monte Carlo SDE simulations. Code: [stochastech/risk/var.py](../../stochastech/risk/var.py).
...
- Backtesting validity: see [02_roadmap.md](../02_roadmap.md) Week 5 for Kupiec POF and Christoffersen tests.
