...
> The objectives optimized to fit Heston parameters $(\kappa, \theta, \xi, \rho, v_0)$ to historical returns. Code: [stochastech/calibration/losses.py](../../stochastech/calibration/losses.py).

## Statement

Two losses are implemented. Both are minimized with Adam through the adjoint solver (see [07_adjoint_sde.md](07_adjoint_sde.md)).
