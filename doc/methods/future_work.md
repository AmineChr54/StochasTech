...
The original `methods_to_use.md` brainstorm cast a wide net across architectures. v1 commits to Neural SDEs only (see [neural_sde.md](neural_sde.md)). Everything below is parked for Phase 3+.
...
Combines PINNs with Fourier Neural Operators to handle non-linear volatility spikes and multi-scale dynamics. Mathematically interesting but needs the C++/CUDA spectral solver from [../architecture/phase2_cpp.md](../architecture/phase2_cpp.md) to be efficient. Phase 3+.
...
- Original brainstorm: archived [`../archive/methods_to_use.md`](../archive/) (post-migration).
