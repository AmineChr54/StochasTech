...
> Python-first stack for the 6-week sprint. The C++/CUDA stack is preserved in [phase2_cpp.md](phase2_cpp.md) for the deferred neuro_ito library.
...
| **torchsde** | Differentiable SDE solving with adjoint | The whole point — see [../math/07_adjoint_sde.md](../math/07_adjoint_sde.md). |
...
C++20, CUDA C++ (nvcc), CMake, Eigen 3, nanobind/pybind11, Google Test, Clang-Format, Clang-Tidy. All preserved in [phase2_cpp.md](phase2_cpp.md).
