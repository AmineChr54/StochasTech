...
- Spectral methods / FNO / multi-domain physics. Those belong to the original Aether-Flow vision and are not part of this project. See [Future Work](../project/future-work.md).
