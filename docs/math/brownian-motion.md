...
This is the single most important fact about Brownian motion. It says $(dW_t)^2 = dt$ in the box-calculus sense — the second-order term in any Taylor expansion does not vanish, which is exactly what produces Itô's correction (see [ito-calculus.md](ito-calculus.md)).
