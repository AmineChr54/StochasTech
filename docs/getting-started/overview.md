...
| 2 | C++/CUDA `neuro_ito` library — see [Phase 2 C++/CUDA](../architecture/phase2-cpp.md) | Backlog |
| 3 | Integration with the live ORIA portfolio pipeline — see [ORIA Inspiration](../project/oria-inspiration.md) | Backlog |
